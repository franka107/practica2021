              ...
              <Paper elevation={4} className={classes.card}>
                ...
                <div className="">
                  ...
                  <Grid container className={classes.generalFeature} xs={12}>
                    ...
                    <Grid item xs={9}>
                      <Typography>
                        {currentAnimal && currentAnimal.gender === "H"
                          ? "Hembra"
                          : "Macho"}
                      </Typography>
                    </Grid>
                      ...
                      >
                        ...
                        <Grid item xs={7}>
                          <Typography>
                            ...
                            {currentAnimal && currentAnimal.percentageRacial1}%
                          </Typography>
                        </Grid>
                      </Grid>
                      {currentAnimal &&
                        ...
                        >
                          ...
                          <Grid item xs={7}>
                            <Typography>
                              ...
                              {currentAnimal && currentAnimal.percentageRacial2}
                              %
                            </Typography>
                          </Grid>
                        </Grid>
                  ...
                  >
                    ...
                    <div className="">
                      ...
                      >
                        ...
                        <Grid item xs={7}>
                          <Typography>
                            {currentAnimal && currentAnimal.childBirthNumber}
                          </Typography>
                        </Grid>
                      </Grid>
                      <Grid
                ...
                <div className="">
                  ...
                  <Grid container className={classes.generalFeature} xs={12}>
                    ...
                    <Grid item xs={7}>
                      <Typography>
                        {currentAnimal &&
                          formatDate(new Date(currentAnimal.lastWeightDate))}
                      </Typography>
                    </Grid>
                  </Grid>
                  <Grid container className={classes.generalFeature} xs={12}>
